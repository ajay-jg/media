...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(
    ...
    Log.i(TAG, "Try loading HsDav1dVideoRenderer.");
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("androidx.media3.decoder.hsdav1d.HsDav1dVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
      ...
      // Expected if the app was built without the extension.
      Log.e(TAG, "Failed to load HsDav1dVideoRenderer. e "+e);
    } catch (Exception e) {
      // The extension is present, but instantiation failed.
      Log.e(TAG, "Failed to load HsDav1dVideoRenderer. e "+e);
      throw new RuntimeException("Error instantiating HS DAV1D AV1 extension", e);
    }
